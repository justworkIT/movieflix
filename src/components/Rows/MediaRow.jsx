    ...
    <section className="mb-8">
      ...
      <div className="relative mt-2">
        <button
          ...
          className="absolute left-0 top-0 z-20 hidden h-[calc(100%-0px)] w-[40px] items-center justify-center bg-black/45 text-3xl text-white transition hover:bg-black/70 md:flex"
        ...
        <button
          ...
          className="absolute right-0 top-0 z-20 hidden h-[calc(100%-0px)] w-[40px] items-center justify-center bg-black/45 text-3xl text-white transition hover:bg-black/70 md:flex"
